...
<LinkButton href="https://www.postgresql.org/docs/current/index.html">PostgreSQL Docs</LinkButton>
<LinkButton href="https://www.psycopg.org/psycopg3/docs/basic/index.html">psycopg3 Docs</LinkButton>
...
<Steps>
    ...
    4. Run `\c db_name` to navigate to said database
    
    5. To import a SQL database, run `\i 'C:/Users/monalisa/Documents/Path/To/Database/File.db.sql'`
</Steps>
...
<Steps>
    1. Run `CREATE USER username WITH PASSWORD 'password';` where `username` matches your system username. Check `C:/Users` to view the users. Your account will be listed there.
    
    2. Run `ALTER USER username WITH SUPERUSER;` to give the newly created account `SUPERUSER` status
    
    3. Restart postgres or restart your computer
    
    4. To update your password, run `ALTER USER username WITH PASSWORD 'new_password';`
    
    5. To explicitly grant connection access, run `GRANT CONNECT ON DATABASE db_name TO username;`
</Steps>
